...
esptool.py --chip esp32 --port /dev/ttyUSB0 --baud 460800 write_flash -z 0x1000 micropython_3ff7079_esp32_idf4.x_ble_camera.bin
```
...
1. Clone the MicroPython repository:
    ...
    ```
    Note: The MicroPython repo changes a lot, I've done this using the version with the hash 3ff7079 (release=`1.13.0`).
